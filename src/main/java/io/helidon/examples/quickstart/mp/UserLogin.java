...
public class UserLogin {
	...
	public JsonObject userLogin(@QueryParam("email") String email, @QueryParam("password") String pass)
			throws SQLException {
	...
	public Response validateCookie(@QueryParam("trackId") String trackId, @QueryParam("userId") String userId)
		...
		LOGGER.info("DBOperations:checkRouteRegister" + "   Form Param : trackId===>" + trackId + "<=======userId===>"
				+ userId);
		URI ui = null;
